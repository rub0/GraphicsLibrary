...
namespace Graphics
{
	...
	void IGEntity::Init() {
		...
		glBindVertexArray(vaoID);	
			...
			glBufferData (GL_ARRAY_BUFFER, totalVertices * sizeof(Engine::Vector3), 0, GL_STATIC_DRAW);
	...
	void IGEntity::Render(const GLfloat* MVP) {
		shader.use();				
